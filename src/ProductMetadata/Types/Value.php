...
class Value extends \DTS\eBaySDK\Types\BaseType
{
    ...
    private static $propertyTypes = [
        'text' => [
            'type' => \DTS\eBaySDK\ProductMetadata\Types\StringValue::class,
            'repeatable' => false,
            'attribute' => false,
            'elementName' => 'text'
        ],
        'number' => [
            'type' => \DTS\eBaySDK\ProductMetadata\Types\NumericValue::class,
            'repeatable' => false,
            'attribute' => false,
            'elementName' => 'number'
        ],
        'URL' => [
            'type' => \DTS\eBaySDK\ProductMetadata\Types\URIValue::class,
            'repeatable' => false,
            'attribute' => false,
            'elementName' => 'URL'
        ]
