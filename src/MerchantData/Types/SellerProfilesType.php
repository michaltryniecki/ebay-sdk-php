...
class SellerProfilesType extends \DTS\eBaySDK\Types\BaseType
{
    ...
    private static $propertyTypes = [
        'SellerShippingProfile' => [
            'type' => \DTS\eBaySDK\MerchantData\Types\SellerShippingProfileType::class,
            'repeatable' => false,
            'attribute' => false,
            'elementName' => 'SellerShippingProfile'
        ],
        'SellerReturnProfile' => [
            'type' => \DTS\eBaySDK\MerchantData\Types\SellerReturnProfileType::class,
            'repeatable' => false,
            'attribute' => false,
            'elementName' => 'SellerReturnProfile'
        ],
        'SellerPaymentProfile' => [
            'type' => \DTS\eBaySDK\MerchantData\Types\SellerPaymentProfileType::class,
            'repeatable' => false,
            'attribute' => false,
