...
class MaximumUnpaidItemStrikesInfoDetailsType extends \DTS\eBaySDK\Types\BaseType
{
    ...
    private static $propertyTypes = [
        'MaximumUnpaidItemStrikesCount' => [
            'type' => \DTS\eBaySDK\Trading\Types\MaximumUnpaidItemStrikesCountDetailsType::class,
            'repeatable' => false,
            'attribute' => false,
            'elementName' => 'MaximumUnpaidItemStrikesCount'
        ],
        'MaximumUnpaidItemStrikesDuration' => [
            'type' => \DTS\eBaySDK\Trading\Types\MaximumUnpaidItemStrikesDurationDetailsType::class,
            'repeatable' => true,
            'attribute' => false,
