...
class GetMyMessagesRequestType extends \DTS\eBaySDK\Trading\Types\AbstractRequestType
{
    ...
    private static $propertyTypes = [
        'MessageIDs' => [
            'type' => \DTS\eBaySDK\Trading\Types\MyMessagesMessageIDArrayType::class,
            'repeatable' => false,
            'attribute' => false,
        ...
        'ExternalMessageIDs' => [
            'type' => \DTS\eBaySDK\Trading\Types\MyMessagesExternalMessageIDArrayType::class,
            'repeatable' => false,
            'attribute' => false,
    ...
    public function __construct(array $values = [])
    {
        ...
        if (!array_key_exists(self::class, self::$requestXmlRootElementNames)) {
            self::$requestXmlRootElementNames[self::class] = 'GetMyMessagesRequest';
        }
