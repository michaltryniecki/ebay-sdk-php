...
class SellerProfilesType extends \DTS\eBaySDK\Types\BaseType
{
    ...
    private static $propertyTypes = [
        'SellerShippingProfile' => [
            'type' => \DTS\eBaySDK\Trading\Types\SellerShippingProfileType::class,
            'repeatable' => false,
            'attribute' => false,
            'elementName' => 'SellerShippingProfile'
        ],
        'SellerReturnProfile' => [
            'type' => \DTS\eBaySDK\Trading\Types\SellerReturnProfileType::class,
            'repeatable' => false,
            'attribute' => false,
            'elementName' => 'SellerReturnProfile'
        ],
        'SellerPaymentProfile' => [
            'type' => \DTS\eBaySDK\Trading\Types\SellerPaymentProfileType::class,
            'repeatable' => false,
            'attribute' => false,
