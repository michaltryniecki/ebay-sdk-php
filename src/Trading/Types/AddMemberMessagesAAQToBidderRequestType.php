...
class AddMemberMessagesAAQToBidderRequestType extends \DTS\eBaySDK\Trading\Types\AbstractRequestType
{
    ...
    private static $propertyTypes = [
        'AddMemberMessagesAAQToBidderRequestContainer' => [
            'type' => \DTS\eBaySDK\Trading\Types\AddMemberMessagesAAQToBidderRequestContainerType::class,
            'repeatable' => true,
            'attribute' => false,
    ...
    public function __construct(array $values = [])
    {
        ...
        if (!array_key_exists(self::class, self::$requestXmlRootElementNames)) {
            self::$requestXmlRootElementNames[self::class] = 'AddMemberMessagesAAQToBidderRequest';
        }
