...
class InventoryItem extends \DTS\eBaySDK\Types\BaseType
{
    ...
    private static $propertyTypes = [
        'availability' => [
            'type' => \DTS\eBaySDK\Inventory\Types\Availability::class,
            'repeatable' => false,
            'attribute' => false,
        ...
        'packageWeightAndSize' => [
            'type' => \DTS\eBaySDK\Inventory\Types\PackageWeightAndSize::class,
            'repeatable' => false,
            'attribute' => false,
            'elementName' => 'packageWeightAndSize'
        ],
        'product' => [
            'type' => \DTS\eBaySDK\Inventory\Types\Product::class,
            'repeatable' => false,
            'attribute' => false,
            'elementName' => 'product'
        ],
