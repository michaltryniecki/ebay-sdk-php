...
class GetCampaignByNameRestResponseTest extends \PHPUnit\Framework\TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\Marketing\Types\GetCampaignByNameRestResponse::class, $this->obj);
    }
