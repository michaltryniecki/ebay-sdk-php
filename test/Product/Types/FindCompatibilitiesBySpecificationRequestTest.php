...
class FindCompatibilitiesBySpecificationRequestTest extends \PHPUnit\Framework\TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\Product\Types\FindCompatibilitiesBySpecificationRequest::class, $this->obj);
    }
