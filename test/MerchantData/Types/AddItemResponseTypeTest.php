...
class AddItemResponseTypeTest extends \PHPUnit\Framework\TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\MerchantData\Types\AddItemResponseType::class, $this->obj);
    }
