...
class EndFixedPriceItemRequestTypeTest extends \PHPUnit\Framework\TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\MerchantData\Types\EndFixedPriceItemRequestType::class, $this->obj);
    }
