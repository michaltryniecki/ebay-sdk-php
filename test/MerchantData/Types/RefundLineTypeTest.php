...
class RefundLineTypeTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\MerchantData\Types\RefundLineType::class, $this->obj);
    }

    public function testExtendsAmountType()
    {
        $this->assertInstanceOf(\DTS\eBaySDK\MerchantData\Types\AmountType::class, $this->obj);
    }
}
