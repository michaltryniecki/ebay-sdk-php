...
class GetSearchKeywordsRecommendationRequestTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\Finding\Types\GetSearchKeywordsRecommendationRequest::class, $this->obj);
    }

    public function testExtendsBaseServiceRequest()
    {
        $this->assertInstanceOf(\DTS\eBaySDK\Finding\Types\BaseServiceRequest::class, $this->obj);
    }
}
