...
class CreateDSRSummaryResponseTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\Feedback\Types\CreateDSRSummaryResponse::class, $this->obj);
    }

    public function testExtendsBaseServiceResponse()
    {
        $this->assertInstanceOf(\DTS\eBaySDK\Feedback\Types\BaseServiceResponse::class, $this->obj);
    }
}
