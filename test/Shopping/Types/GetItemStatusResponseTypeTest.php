...
class GetItemStatusResponseTypeTest extends \PHPUnit\Framework\TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\Shopping\Types\GetItemStatusResponseType::class, $this->obj);
    }
