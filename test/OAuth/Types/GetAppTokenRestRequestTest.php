...
class GetAppTokenRestRequestTest extends \PHPUnit\Framework\TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\OAuth\Types\GetAppTokenRestRequest::class, $this->obj);
    }
