...
class ProvideTrackingInfoRequestTest extends \PHPUnit\Framework\TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\ResolutionCaseManagement\Types\ProvideTrackingInfoRequest::class, $this->obj);
    }
