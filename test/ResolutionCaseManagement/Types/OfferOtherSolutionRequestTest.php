...
class OfferOtherSolutionRequestTest extends \PHPUnit\Framework\TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\ResolutionCaseManagement\Types\OfferOtherSolutionRequest::class, $this->obj);
    }
