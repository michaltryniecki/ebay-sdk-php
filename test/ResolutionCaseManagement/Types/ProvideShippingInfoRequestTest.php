...
class ProvideShippingInfoRequestTest extends \PHPUnit\Framework\TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\ResolutionCaseManagement\Types\ProvideShippingInfoRequest::class, $this->obj);
    }
