...
class EscalateToCustomerSupportRequestTest extends \PHPUnit\Framework\TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\ResolutionCaseManagement\Types\EscalateToCustomerSupportRequest::class, $this->obj);
    }
