...
class AppealToCustomerSupportOptionTypeTest extends \PHPUnit\Framework\TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\ResolutionCaseManagement\Types\AppealToCustomerSupportOptionType::class, $this->obj);
    }
