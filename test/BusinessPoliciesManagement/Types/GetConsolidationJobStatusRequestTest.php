...
class GetConsolidationJobStatusRequestTest extends \PHPUnit\Framework\TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\BusinessPoliciesManagement\Types\GetConsolidationJobStatusRequest::class, $this->obj);
    }
