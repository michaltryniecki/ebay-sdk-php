...
class GetSellerProfilesResponseTest extends \PHPUnit\Framework\TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\BusinessPoliciesManagement\Types\GetSellerProfilesResponse::class, $this->obj);
    }
