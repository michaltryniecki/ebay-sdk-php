...
class RemoveOverridesResponseTest extends \PHPUnit\Framework\TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\BusinessPoliciesManagement\Types\RemoveOverridesResponse::class, $this->obj);
    }
