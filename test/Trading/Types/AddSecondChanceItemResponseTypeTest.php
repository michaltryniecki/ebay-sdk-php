...
class AddSecondChanceItemResponseTypeTest extends \PHPUnit\Framework\TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\Trading\Types\AddSecondChanceItemResponseType::class, $this->obj);
    }
