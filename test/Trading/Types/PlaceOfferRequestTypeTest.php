...
class PlaceOfferRequestTypeTest extends \PHPUnit\Framework\TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\Trading\Types\PlaceOfferRequestType::class, $this->obj);
    }
