...
class AddSecondChanceItemRequestTypeTest extends \PHPUnit\Framework\TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\Trading\Types\AddSecondChanceItemRequestType::class, $this->obj);
    }
