...
class GetStoreCategoryUpdateStatusResponseTypeTest extends \PHPUnit\Framework\TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\Trading\Types\GetStoreCategoryUpdateStatusResponseType::class, $this->obj);
    }
