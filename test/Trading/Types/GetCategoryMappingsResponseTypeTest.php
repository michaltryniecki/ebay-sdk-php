...
class GetCategoryMappingsResponseTypeTest extends \PHPUnit\Framework\TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\Trading\Types\GetCategoryMappingsResponseType::class, $this->obj);
    }
