...
class ReviseSellingManagerProductResponseTypeTest extends \PHPUnit\Framework\TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\Trading\Types\ReviseSellingManagerProductResponseType::class, $this->obj);
    }
