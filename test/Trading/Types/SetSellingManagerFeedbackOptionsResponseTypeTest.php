...
class SetSellingManagerFeedbackOptionsResponseTypeTest extends \PHPUnit\Framework\TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\Trading\Types\SetSellingManagerFeedbackOptionsResponseType::class, $this->obj);
    }
