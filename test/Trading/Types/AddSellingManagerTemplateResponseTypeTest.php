...
class AddSellingManagerTemplateResponseTypeTest extends \PHPUnit\Framework\TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\Trading\Types\AddSellingManagerTemplateResponseType::class, $this->obj);
    }
