...
class SetSellingManagerFeedbackOptionsRequestTypeTest extends \PHPUnit\Framework\TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\Trading\Types\SetSellingManagerFeedbackOptionsRequestType::class, $this->obj);
    }
