...
class ReviseSellingManagerSaleRecordResponseTypeTest extends \PHPUnit\Framework\TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\Trading\Types\ReviseSellingManagerSaleRecordResponseType::class, $this->obj);
    }
