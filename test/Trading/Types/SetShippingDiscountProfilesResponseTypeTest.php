...
class SetShippingDiscountProfilesResponseTypeTest extends \PHPUnit\Framework\TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\Trading\Types\SetShippingDiscountProfilesResponseType::class, $this->obj);
    }
