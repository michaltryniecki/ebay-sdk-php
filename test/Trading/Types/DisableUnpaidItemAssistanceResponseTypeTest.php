...
class DisableUnpaidItemAssistanceResponseTypeTest extends \PHPUnit\Framework\TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\Trading\Types\DisableUnpaidItemAssistanceResponseType::class, $this->obj);
    }
