...
class SetPromotionalSaleResponseTypeTest extends \PHPUnit\Framework\TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\Trading\Types\SetPromotionalSaleResponseType::class, $this->obj);
    }
