...
class GetApiAccessRulesResponseTypeTest extends \PHPUnit\Framework\TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\Trading\Types\GetApiAccessRulesResponseType::class, $this->obj);
    }
