...
class ValidateTestUserRegistrationRequestTypeTest extends \PHPUnit\Framework\TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\Trading\Types\ValidateTestUserRegistrationRequestType::class, $this->obj);
    }
