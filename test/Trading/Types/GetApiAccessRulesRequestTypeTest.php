...
class GetApiAccessRulesRequestTypeTest extends \PHPUnit\Framework\TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\Trading\Types\GetApiAccessRulesRequestType::class, $this->obj);
    }
