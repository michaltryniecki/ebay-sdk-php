...
class GetDescriptionTemplatesRequestTypeTest extends \PHPUnit\Framework\TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\Trading\Types\GetDescriptionTemplatesRequestType::class, $this->obj);
    }
