...
class LeaveFeedbackResponseTypeTest extends \PHPUnit\Framework\TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\Trading\Types\LeaveFeedbackResponseType::class, $this->obj);
    }
