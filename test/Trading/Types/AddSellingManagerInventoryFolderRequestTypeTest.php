...
class AddSellingManagerInventoryFolderRequestTypeTest extends \PHPUnit\Framework\TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\Trading\Types\AddSellingManagerInventoryFolderRequestType::class, $this->obj);
    }
