...
class VerifyAddSecondChanceItemRequestTypeTest extends \PHPUnit\Framework\TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\Trading\Types\VerifyAddSecondChanceItemRequestType::class, $this->obj);
    }
