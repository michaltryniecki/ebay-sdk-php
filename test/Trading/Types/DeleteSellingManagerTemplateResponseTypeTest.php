...
class DeleteSellingManagerTemplateResponseTypeTest extends \PHPUnit\Framework\TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\Trading\Types\DeleteSellingManagerTemplateResponseType::class, $this->obj);
    }
