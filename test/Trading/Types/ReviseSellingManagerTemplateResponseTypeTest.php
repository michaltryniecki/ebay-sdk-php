...
class ReviseSellingManagerTemplateResponseTypeTest extends \PHPUnit\Framework\TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\Trading\Types\ReviseSellingManagerTemplateResponseType::class, $this->obj);
    }
