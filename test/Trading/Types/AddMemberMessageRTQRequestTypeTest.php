...
class AddMemberMessageRTQRequestTypeTest extends \PHPUnit\Framework\TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\Trading\Types\AddMemberMessageRTQRequestType::class, $this->obj);
    }
