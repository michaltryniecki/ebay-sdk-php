...
class AddSellingManagerTemplateRequestTypeTest extends \PHPUnit\Framework\TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\Trading\Types\AddSellingManagerTemplateRequestType::class, $this->obj);
    }
