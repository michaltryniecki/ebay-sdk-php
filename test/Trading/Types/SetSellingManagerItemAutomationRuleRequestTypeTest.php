...
class SetSellingManagerItemAutomationRuleRequestTypeTest extends \PHPUnit\Framework\TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\Trading\Types\SetSellingManagerItemAutomationRuleRequestType::class, $this->obj);
    }
