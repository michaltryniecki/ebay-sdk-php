...
class GetDescriptionTemplatesResponseTypeTest extends \PHPUnit\Framework\TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\Trading\Types\GetDescriptionTemplatesResponseType::class, $this->obj);
    }
