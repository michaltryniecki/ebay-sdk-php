...
class GetItemsAwaitingFeedbackRequestTypeTest extends \PHPUnit\Framework\TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\Trading\Types\GetItemsAwaitingFeedbackRequestType::class, $this->obj);
    }
