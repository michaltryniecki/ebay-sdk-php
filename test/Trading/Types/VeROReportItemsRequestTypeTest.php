...
class VeROReportItemsRequestTypeTest extends \PHPUnit\Framework\TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\Trading\Types\VeROReportItemsRequestType::class, $this->obj);
    }
