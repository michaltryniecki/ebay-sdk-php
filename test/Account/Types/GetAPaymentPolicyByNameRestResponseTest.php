...
class GetAPaymentPolicyByNameRestResponseTest extends \PHPUnit\Framework\TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\Account\Types\GetAPaymentPolicyByNameRestResponse::class, $this->obj);
    }
