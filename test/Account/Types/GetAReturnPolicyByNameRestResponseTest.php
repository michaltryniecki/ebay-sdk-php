...
class GetAReturnPolicyByNameRestResponseTest extends \PHPUnit\Framework\TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\Account\Types\GetAReturnPolicyByNameRestResponse::class, $this->obj);
    }
