...
class GetAFulfillmentPolicyByIDRestResponseTest extends \PHPUnit\Framework\TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\Account\Types\GetAFulfillmentPolicyByIDRestResponse::class, $this->obj);
    }
