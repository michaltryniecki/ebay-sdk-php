...
class PublishOfferByInventoryItemGroupRestRequestTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\Inventory\Types\PublishOfferByInventoryItemGroupRestRequest::class, $this->obj);
    }

    public function testExtendsPublishByInventoryItemGroupRequest()
    {
        $this->assertInstanceOf(\DTS\eBaySDK\Inventory\Types\PublishByInventoryItemGroupRequest::class, $this->obj);
    }
}
