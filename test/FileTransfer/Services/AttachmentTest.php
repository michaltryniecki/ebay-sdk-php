...
class AttachmentTest extends \PHPUnit\Framework\TestCase
{
    public function testAttachmentFieldIsSetCorrectlyInRequest()
    {
        ...
        $this->assertEquals(null, $r->fileAttachment);
        $s->uploadFile($r);
        $this->assertInstanceOf(\DTS\eBaySDK\FileTransfer\Types\FileAttachment::class, $r->fileAttachment);
        $this->assertInstanceOf(\DTS\eBaySDK\FileTransfer\Types\Data::class, $r->fileAttachment->Data);
        $this->assertInstanceOf(\DTS\eBaySDK\FileTransfer\Types\XopInclude::class, $r->fileAttachment->Data->xopInclude);
