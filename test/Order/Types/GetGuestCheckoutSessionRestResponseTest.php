...
class GetGuestCheckoutSessionRestResponseTest extends \PHPUnit\Framework\TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\Order\Types\GetGuestCheckoutSessionRestResponse::class, $this->obj);
    }
