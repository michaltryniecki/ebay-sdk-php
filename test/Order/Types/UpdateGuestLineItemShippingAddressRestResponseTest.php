...
class UpdateGuestLineItemShippingAddressRestResponseTest extends \PHPUnit\Framework\TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\Order\Types\UpdateGuestLineItemShippingAddressRestResponse::class, $this->obj);
    }
