...
class UpdateGuestPaymentInfoRestRequestTest extends \PHPUnit\Framework\TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\Order\Types\UpdateGuestPaymentInfoRestRequest::class, $this->obj);
    }
