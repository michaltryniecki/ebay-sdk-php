...
class GetCheckoutSessionRestResponseTest extends \PHPUnit\Framework\TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\Order\Types\GetCheckoutSessionRestResponse::class, $this->obj);
    }
