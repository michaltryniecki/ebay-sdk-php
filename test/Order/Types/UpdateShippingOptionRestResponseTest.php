...
class UpdateShippingOptionRestResponseTest extends \PHPUnit\Framework\TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\Order\Types\UpdateShippingOptionRestResponse::class, $this->obj);
    }
