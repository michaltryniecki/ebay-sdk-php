...
class UpdateQuantityForLineItemRestResponseTest extends \PHPUnit\Framework\TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\Order\Types\UpdateQuantityForLineItemRestResponse::class, $this->obj);
    }
