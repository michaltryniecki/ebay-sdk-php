...
class UpdateShippingAddressRestRequestTest extends \PHPUnit\Framework\TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\Order\Types\UpdateShippingAddressRestRequest::class, $this->obj);
    }
