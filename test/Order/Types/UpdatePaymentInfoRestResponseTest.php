...
class UpdatePaymentInfoRestResponseTest extends \PHPUnit\Framework\TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\Order\Types\UpdatePaymentInfoRestResponse::class, $this->obj);
    }
