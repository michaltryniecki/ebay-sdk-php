...
class SuspendRecurringJobResponseTest extends \PHPUnit\Framework\TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\BulkDataExchange\Types\SuspendRecurringJobResponse::class, $this->obj);
    }
