...
class ActivateRecurringJobResponseTest extends \PHPUnit\Framework\TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\BulkDataExchange\Types\ActivateRecurringJobResponse::class, $this->obj);
    }
