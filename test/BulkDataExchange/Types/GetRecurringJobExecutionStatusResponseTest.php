...
class GetRecurringJobExecutionStatusResponseTest extends \PHPUnit\Framework\TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\BulkDataExchange\Types\GetRecurringJobExecutionStatusResponse::class, $this->obj);
    }
