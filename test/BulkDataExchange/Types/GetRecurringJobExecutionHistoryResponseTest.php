...
class GetRecurringJobExecutionHistoryResponseTest extends \PHPUnit\Framework\TestCase
{
    private $obj;
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\BulkDataExchange\Types\GetRecurringJobExecutionHistoryResponse::class, $this->obj);
    }
