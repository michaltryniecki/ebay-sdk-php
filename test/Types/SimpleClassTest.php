...
class SimpleClassTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testGettingSettingProperties()
    {
        ...
        $this->assertInstanceOf(\DTS\eBaySDK\Types\RepeatableType::class, $this->obj->integers);
        ...
        $this->assertInstanceOf(\DTS\eBaySDK\Types\RepeatableType::class, $this->obj->anyTypes);
        $this->obj->anyTypes[] = 1;
    ...
    public function testCanGetElementMeta()
    {
        ...
        $meta->phpType = \DTS\eBaySDK\Test\Mocks\SimpleClass::class;
