...
class GetStoreCategoriesRestResponseTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\PostOrder\Types\GetStoreCategoriesRestResponse::class, $this->obj);
    }

    public function testExtendsGetStoreCategoryResponse()
    {
        $this->assertInstanceOf(\DTS\eBaySDK\PostOrder\Types\GetStoreCategoryResponse::class, $this->obj);
    }
}
