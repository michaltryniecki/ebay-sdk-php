...
class CreateCustomListRestRequestTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\PostOrder\Types\CreateCustomListRestRequest::class, $this->obj);
    }

    public function testExtendsCreateCustomListRequest()
    {
        $this->assertInstanceOf(\DTS\eBaySDK\PostOrder\Types\CreateCustomListRequest::class, $this->obj);
    }
}
