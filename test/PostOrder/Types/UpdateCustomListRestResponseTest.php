...
class UpdateCustomListRestResponseTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\PostOrder\Types\UpdateCustomListRestResponse::class, $this->obj);
    }

    public function testExtendsModifyCustomListResponse()
    {
        $this->assertInstanceOf(\DTS\eBaySDK\PostOrder\Types\ModifyCustomListResponse::class, $this->obj);
    }
}
