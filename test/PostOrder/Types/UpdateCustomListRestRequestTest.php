...
class UpdateCustomListRestRequestTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\PostOrder\Types\UpdateCustomListRestRequest::class, $this->obj);
    }

    public function testExtendsModifyCustomListRequest()
    {
        $this->assertInstanceOf(\DTS\eBaySDK\PostOrder\Types\ModifyCustomListRequest::class, $this->obj);
    }
}
