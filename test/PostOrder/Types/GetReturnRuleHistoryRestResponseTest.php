...
class GetReturnRuleHistoryRestResponseTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\PostOrder\Types\GetReturnRuleHistoryRestResponse::class, $this->obj);
    }

    public function testExtendsGetDispositionRuleTriggerHistResponse()
    {
        $this->assertInstanceOf(\DTS\eBaySDK\PostOrder\Types\GetDispositionRuleTriggerHistResponse::class, $this->obj);
    }
}
