...
class GetCancellationRestResponseTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->assertInstanceOf(\DTS\eBaySDK\PostOrder\Types\GetCancellationRestResponse::class, $this->obj);
    }

    public function testExtendsGetCancelDetailResponse()
    {
        $this->assertInstanceOf(\DTS\eBaySDK\PostOrder\Types\GetCancelDetailResponse::class, $this->obj);
    }
}
